################################################################################
# plot_20_water_profiles.jl
# TYPE: Supporting (plot maker)
# WHICH: Perturbation experiments
# DESCRIPTION: Plots the enhanced water profiles used in the 
# photochemical model. That is, 20 profiles, all ppm, all altitudes.
#
# Eryn Cangi
# March 2019
...
function plot_water_profile(thepath, thefile)#, packettype)
    ...
    # TODO: This syntax has to change for Julia 0.7 and 1.0, I think, but not 100% sure on the new format.
    ...
    savefig(thepath*"20waterprofiles.png")
end
