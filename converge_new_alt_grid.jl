...
# Martian atmosphere, extending an original atmosphere file that only went to 
# 200 km up to 250 km. All abundances are constant from 200-250 km. The output
# atmosphere file, converged_starter_atmosphere, must be used for all actual
# model runs so that the H2O profiles are set correctly, and do not end up with
# a constant abundance above 200 km.
# 
# Eryn Cangi
# 2018-2019
...
readfile = research_dir*"converged.h5"
...
towrite = results_dir*FNext*"/converged_starter_atmosphere.h5"
